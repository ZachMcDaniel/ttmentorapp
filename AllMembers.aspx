...
<link href='https://fonts.googleapis.com/css?family=Poppins' rel='stylesheet'>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
        ...
        <asp:SqlDataSource ID="GridView" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
        SelectCommand="SELECT [Email] FROM [AspNetUsers]" OldValuesParameterFormatString="original_{0}" 
        DeleteCommand="DELETE FROM [AspNetUsers] where [Email] = @original_Email">
            <DeleteParameters>
